...
- https://codepen.io/nnnpooh/pen/eYEXrjZ
  - `em` looks at its own font size, while `rem` looks at the root font size.
...
- Inline elements
  ...
  - **Cannot** add height to the top or bottom padding or margin. (Technically, you can, but it will not affect the layout.)
...
- Also, see this [guide](https://css-tricks.com/snippets/css/a-guide-to-flexbox/).
