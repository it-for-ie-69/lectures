...
// We can also change the style of #div1
...
This is a more common way to select elements in the DOM.

```js
// Get the first element with id="div1"
const div1 = document.getElementById("div1");

// Get the first element with id="div2"
const div2 = document.getElementById("div2");
```

---

# DOM Selection - `querySelector` and `querySelectorAll`

```js
// Get the first element with the id "div1"
const div1 = document.querySelector("#div1");

// Get the first element with the class name "div1"
const div1 = document.querySelector(".div1"); // (return "none" here)

// Get the first element with the tag name "div"
...
![alt text](./img/paste-1783659508011.png)
