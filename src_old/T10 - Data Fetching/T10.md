...
- Let's send message to a discord group.
...
```js
fetch(`${CORS_PROXY}/${DISCORD_WEBHOOK}`, {
  method: "POST",
  headers: {
  ...
  body: JSON.stringify({
    ...
    username: "Webhook Bot", // optional
    avatar_url: "https://picsum.photos/200/300", // optional
  }),
});
```
...
- Use `headers`
- Send content (body) as a json string.
